...
const Skills = () => {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg, #070c17 0%, #080d1a 55%, #070c17 100%)" }}
    >
      {/* Animated Background Orbs */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-primary-600/7 rounded-full filter blur-[130px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-purple-600/7 rounded-full filter blur-[130px] animation-delay-2000" />
      </div>
